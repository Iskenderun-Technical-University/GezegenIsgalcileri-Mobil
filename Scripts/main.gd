...
func wave1():
	...
	pathLoader(path1Node, Vector2(0, -100), 0, 10)
	yield(get_tree().create_timer(2), "timeout")
	pathLoader(path1Node, Vector2(300, 0), -20, 10)
	pathLoader(path1Node, Vector2(300, -100), -20, 10)
	yield(get_tree().create_timer(2), "timeout")
	pathLoader(path1Node, Vector2(0, 0), 30, 10)
	pathLoader(path1Node, Vector2(0, -100), 30, 10)
	yield(get_tree().create_timer(2), "timeout")
	pathLoader(path1Node, Vector2(200, 0), -15, 10)
	pathLoader(path1Node, Vector2(200, -100), -15, 10)
	yield(get_tree().create_timer(2), "timeout")
	pathLoader(path1Node, Vector2(0, 0), 10, 10)
	pathLoader(path1Node, Vector2(0, -100), 10, 10)
	yield(get_tree().create_timer(2), "timeout")
	callMeteor(Vector2(200, 0), -20, 550)
	yield(get_tree().create_timer(0.8), "timeout")
	callMeteor(Vector2(150, 0), 10, 460)
	...
	callMeteor(Vector2(260, 0), 8, 480)
	yield(get_tree().create_timer(2), "timeout")
	pathLoader(path2Node, Vector2(0, 0), 0, 10)
	pathLoader(path2Node, Vector2(-100, 0), 0, 10)
	pathLoader(path2Node, Vector2(100, 0), 0, 10)
	pathLoader(path2Node, Vector2(200, 0), 0, 10)
	pathLoader(path2Node, Vector2(-200, 0), 0, 10)
